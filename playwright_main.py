    ...
    while True:
        try:
            ...
            if subject == "statusc":
                ...
                ping_camera = "ping" + " " + camera_ip + " -c 3 " " > output.txt"
                os.system(ping_camera)
                sleep(1)
                try:
            ...
            if subject == "cap":
                ...
                try:
                    with sync_playwright() as p:
                        ...
                        page.goto(url)
                        a = page.locator('xpath=/html/body/div[1]/p[2]/button[2]')
                        a.click()
                        page.wait_for_timeout(1000)
                        browser.close()
                except Exception as e:
                    print("ERROR: Failed to start playwright")
                    print(e)
                    error_selenium = e
                ...
                # download image
                try:
                    res = requests.get(url_image).content
                ...
                time = str(hour) + "," + str(min) + "," + str(sec) + ".jpg"
